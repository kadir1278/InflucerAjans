        ...
        public ActionResult TR(ContactMail contactMail)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    mailMessage.To.Add(new MailAddress("influencerajans@outlook.com.tr", "Influencer Ajans İletişim"));
        ...
        public ActionResult EN(ContactMail contactMail)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    mailMessage.To.Add(new MailAddress("influencerajans@outlook.com.tr", "Influencer Agency Contact"));
                    mailMessage.Subject = contactMail.Subject;
